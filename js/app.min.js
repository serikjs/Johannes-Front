...
function maps() {
  ...
  function initMap(coordLat, coordLng, el) {
    let coordinates = {
      lat: coordLat,
      lng: coordLng
    };
  ...
  mapsel.forEach(element => {
    const coordLat = +element.dataset.lat;
    const coordLng = +element.dataset.lng;
    initMap(coordLat, coordLng, element);
  });
}
...
function pageBg() {
  window.addEventListener('DOMContentLoaded', () => {
    ...
    const cof = Math.floor(array.length * (wrapper.offsetHeight / (5173 + footer.offsetHeight)));
    let t = [];
...
/* harmony import */ var _modules_maps_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/maps.js */ "./src/js/modules/maps.js");
/* harmony import */ var _modules_page_bg_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/page-bg.js */ "./src/js/modules/page-bg.js");
...
try {
  (0,_modules_page_bg_js__WEBPACK_IMPORTED_MODULE_8__["default"])();
} catch (error) {
  console.log();
}
})();
